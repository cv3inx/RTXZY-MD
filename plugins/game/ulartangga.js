 ...
 * JOIN SL COMMUNITY
 */
import { drawBoard } from '../../lib/games/ular_tangga.js';
...
const handler = {
  ...
  tags: 'game',
  owner: false,
  before: async function (m, { conn, text, command }) {
