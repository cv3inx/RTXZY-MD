...
const handler = {
  command: ['ai', 'openai', 'chatgpt'],
  help: ['ai', 'openai', 'chatgpt'],
  tags: ['ai'],
  premium: false,
  limit: true,
  run: async (m, { conn, text, usedPrefix, command }) => {
    ...
    try {
      ...
      if (res && res.result) {
        ...
        conn.btch[m.sender].pesan = [...conn.btch[m.sender].pesan, text, res.result];
      } else {
