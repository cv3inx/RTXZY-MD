    ...
    if (conn.sessionAI[m.sender] && m.text) {
      ...
      try {
        ...
        if (res && res.result) {
          ...
          conn.sessionAI[m.sender].sessionChat = [...conn.sessionAI[m.sender].sessionChat, m.text, res.result];
        } else {
