...
╰════════════════════`);
  ...
  try {
    ...
    const soulTypes = ['Pemimpin Yang Berani', 'Penyeimbang Bijaksana', 'Kreator Ekspresif', 'Pembangun Solid', 'Petualang Bebas', 'Pelindung Setia', 'Pemikir Mistis', 'Penakluk Kuat', 'Humanitarian Murni'];
    ...
    const generateSoulReading = (compatibility) => {
      const readings = [compatibility >= 90 ? ['│ ✨ Jiwa kalian memiliki koneksi yang sangat', '│    istimewa dan langka', '│ 🌟 Takdir telah merencanakan pertemuan ini', '│ 💫 Resonansi jiwa kalian menciptakan', '│    harmoni sempurna'] : compatibility >= 80 ? ['│ 🌟 Ada chemistry yang sangat kuat di antara', '│    kalian', '│ ✨ Jiwa kalian saling melengkapi dengan', '│    cara yang unik', '│ 💫 Pertemuan kalian membawa energi positif'] : compatibility >= 70 ? ['│ 🌙 Potensi hubungan yang dalam dan berarti', '│ ✨ Perbedaan kalian justru menciptakan', '│    harmoni', '│ 💫 Ada pelajaran berharga dalam pertemuan', '│    ini'] : compatibility >= 60 ? ['│ 🌟 Butuh waktu untuk saling memahami', '│ 💫 Setiap tantangan akan memperkuat ikatan', '│ ✨ Fokus pada hal positif dari perbedaan', '│    kalian'] : compatibility >= 50 ? ['│ 🌙 Perlu usaha ekstra untuk harmonisasi', '│ ✨ Tantangan akan menguji kesungguhan', '│ 💫 Komunikasi jadi kunci utama hubungan'] : ['│ 🌑 Perbedaan yang signifikan dalam energi', '│    jiwa', '│ ✨ Butuh banyak adaptasi dan pengertian', '│ 💫 Setiap hubungan punya maksud tersendiri']];
