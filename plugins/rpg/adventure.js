    ...
    try {
      ...
      if (user.healt > 79) {
        if (new Date() - user.lastadventure > 600000) {
          ...
          let peta = pickRandom(['🏯 Jepang', '🇰🇷 Korea', '🏝️ Bali', '🇺🇸 Amerika', '🇮🇶 Iraq', '🇸🇦 Arab', '🇵🇰 Pakistan', '🇩🇪 German', '🇫🇮 Finlandia', '💤 Ke bawa dunia mimpi', '🌍 Ujung dunia', '🔴 Mars', '🇿🇼 Zimbabwe', '🌕 Bulan', '🔵 Pluto', '☀️ Matahari', '💖 Hatinya dia', '🌲 Hutan Amazon', '🏜️ Gurun Sahara', '🏔️ Pegunungan Himalaya', '🌊 Samudra Atlantik', '🏰 Kastil Terbengkalai', '🌌 Galaksi Andromeda', '🏞️ Grand Canyon', '🏜️ Death Valley', '🏕️ Yosemite', '🏖️ Maldives', '🏙️ New York', '🇮🇳 India', '🇧🇷 Brazil', '🇿🇦 South Africa', '🇦🇺 Australia', '🇨🇦 Canada', '🇷🇺 Russia', '🇲🇽 Mexico', '🇳🇿 New Zealand', '🏞️ Patagonia', '🇫🇷 France', '🇪🇸 Spain', '🇮🇹 Italy', '🇬🇧 United Kingdom', '🇨🇭 Switzerland']);
          let str = `
