...
function createTambangs() {
  const areaNames = ['Emas', 'Perak', 'Berlian', 'Batu Permata', 'Uranium', 'Emas Hitam', 'Kristal', 'Rubi', 'Safir', 'Topaz', 'Ametis', 'Zamrud', 'Opal', 'Kuarsa', 'Safir Merah', 'Topaz Biru', 'Ametis Ungu', 'Rubi Merah', 'Emas Putih', 'Berlian Biru', 'Batu Permata Hitam', 'Uranium Radioaktif', 'Kristal Langka', 'Diam', 'Pirus', 'Garnet', 'Kalimaya', 'Kuarsit', 'Lapis Lazuli', 'Rodokrosit', 'Yaspis', 'Malakit', 'Hessonit', 'Peridot', 'Amber', 'Kornerupin', 'Morganit', 'Labradorit', 'Akuamarin', 'Tanzanite', 'Batu Delima', 'Akuamarin', 'Kunzit', 'Maw-sit-sit', 'Sphene', 'Kyanite', 'Alexandrite', 'Variscite', 'Tambang Baru 1', 'Tambang Baru 2', 'Tambang Baru 3'];
