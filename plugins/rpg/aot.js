    ...
    try {
      ...
      if (user.healt > 79) {
        if (new Date() - user.lastadventure > 600000) {
          ...
          let peta = pickRandom(['Wall Maria', 'Wall Rose', 'Wall Sina', 'Shiganshina District', 'Trost District', 'Stohess District', 'Ragako Village', 'Utgard Castle', 'Forest of Giant Trees', 'Warriors District', 'Yeagerist Base', 'Liberio', 'Marley', 'Paths', 'Fort Slava', 'Paradise Island', 'Mahr Headquarters', 'Odiha', 'Port of Kiyomi', 'Hizuru', 'Port of Marley', 'Underground City', 'Southern Slums', 'Northern Slums', 'Eastern Slums', 'Western Slums', 'Training Grounds', 'Orvud District', 'Utopia District', 'Klorva District', 'Karanes District', 'Kolkhoz Village']);
          let str = `
