const handler = {
  ...
  run: async (m, { conn, usedPrefix }) => {
    ...
    if (user.stamina < 50) return m.reply(`Stamina Mu Tidak Cukup Cobalah Makan / minum Sesuatu .`.trim());
    //if (user.kondom == 0)
...
`.trim();
    ...
    } else m.reply(`Silahkan Menunggu Selama ${timers}, Untuk Melakukan ngentot lagi`);
  }
};
